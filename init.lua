...
require('lazy').setup({
  ...
  },
  {
    ...
    dependencies = {
      ...
      { 'mason-org/mason.nvim', version = '^1.0.0', opts = {} }, -- version fix for Mason breaking changes
      -- see https://github.com/LazyVim/LazyVim/issues/6039#issuecomment-2856227817 and remove once updated
